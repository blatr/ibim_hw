...
class SizableDict:
    ...
    def __init__(self) -> None:
        ...
        """
        self.contacts: tp.Dict[tp.Union[str, int], tp.Set[str]] = defaultdict(set)
        self.unique_contacts_per_member: tp.Dict[tp.Union[str, int], int] = Counter()
...
def count_contacts_per_member(df: EnhancedJsonType) -> tp.Dict[tp.Union[str, int], int]:
    """
...
def count_contacts_per_age_group(df: EnhancedJsonType, age_dict: tp.Dict[str, int]) -> EnhancedJsonType:
    ...
    max_contacts_per_age_group: float = 0
    max_age_group: int = 0
...
def reorder_df(df: EnhancedJsonType, mask: tp.Dict[tp.Union[str, int], tp.Any], agg_column: str) -> EnhancedJsonType:
    """
...
def find_total_duration_per_member(df: EnhancedJsonType) -> tp.Dict[tp.Union[str, int], int]:
    """
    ...
    :rtype: dict
    """
    duration_dict: tp.Dict[tp.Union[str, int], int] = Counter()
    for entry in df:
